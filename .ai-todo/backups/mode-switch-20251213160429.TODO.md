...
## Tasks
- [ ] **#81** 79.6 `Update` `Developer` `Documentation:` `Replace` `legacy` `venv/pip` `instructions` `in` `DEVELOPMENT.md,` `USAGE.md,` `CI_CD.md`
...
**Last Updated:** Sat Dec 13 16:04:15 CET 2025
